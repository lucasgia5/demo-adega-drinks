...
import { LayoutDashboard, Package, PackageOpen, Settings, Tag, ClipboardList, LogOut, Store, Truck } from "lucide-react";
...
const NAV = [
  ...
  { to: "/admin/identidade", label: "Identidade", icon: Settings },
];
